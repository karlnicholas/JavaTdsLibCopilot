...
public class Login7Request {
    ...
    // Fluent setters
    public Login7Request withUserName(String userName) { this.userName = userName; return this; }
    public Login7Request withPassword(String password) { this.password = password; return this; }
    public Login7Request withDatabase(String database) { this.database = database; return this; }
    public Login7Request withAppName(String appName) { this.appName = appName; return this; }
    ...
    public Message toMessage() {
        ...
        int pos = 94;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (hostBytes.length / 2));
        pos += hostBytes.length;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (serverBytes.length / 2));
        pos += serverBytes.length;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (userBytes.length / 2));
        pos += userBytes.length;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (passBytes.length / 2));
        pos += passBytes.length;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (appBytes.length / 2));
        pos += appBytes.length;
        payload.putShort((short) (pos / 2)); payload.putShort((short) (dbBytes.length / 2));
