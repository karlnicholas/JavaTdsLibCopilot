...
/**
 * Parser for the ROW token (0xD1). This token contains the raw data for a single row in a result
 * set. The actual parsing of the row data is deferred to the {@link RawRowToken} and subsequent
 * processing steps, as it requires column metadata.
 */
