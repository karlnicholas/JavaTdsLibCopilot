 ...
 */
public class RpcResponseTokenVisitor implements Flow.Publisher<RowWithMetadata>, TokenVisitor {
  private static final Logger logger = LoggerFactory.getLogger(RpcResponseTokenVisitor.class);
   ...
   *
   */
  public RpcResponseTokenVisitor(
