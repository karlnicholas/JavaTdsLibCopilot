...
public class StringDecoder implements ResultDecoder {
  ...
  public boolean canDecode(TdsType tdsType) {
    return tdsType == TdsType.BIGCHAR || tdsType == TdsType.BIGVARCHR ||
        tdsType == TdsType.VARCHAR || tdsType == TdsType.CHAR || tdsType == TdsType.TEXT ||
        tdsType == TdsType.NVARCHAR || tdsType == TdsType.NCHAR ||
  ...
  private boolean isNationalChar(TdsType tdsType) {
    return tdsType == TdsType.NVARCHAR || tdsType == TdsType.NCHAR ||
        tdsType == TdsType.NTEXT || tdsType == TdsType.XML;
  }
}